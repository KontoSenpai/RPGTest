...
namespace RPGTest.UI
{
    public class UI_ActionButton : MonoBehaviour
    {
        ...
        // Navigation action
        private Enum m_navigationAction;

        public event EnumActionSelectionHandler NavigationActionSelected;
        ...
        public void Initialize(Enum action)
        {
            m_navigationAction = action;
            ActionName.text = action.GetName();
        }
        ...
        public void SelectNavigationAction()
        {
            NavigationActionSelected(m_navigationAction);
        }
    }
}
